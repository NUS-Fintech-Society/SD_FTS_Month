...
import EdiwinChanPhoto from '../../images/edwinchanphoto.png';
    ...
    return (
        <>
            ...
            <Grid className='main-bnpp' justify='center'>
                ...
                <h1>
                    <a target="_blank" rel='noreferrer noopener' href='https://www.linkedin.com/in/edwin-chan-89806012/'>
                        Mr Edwin Chan
                    </a>
                </h1>
                <img src={EdiwinChanPhoto} alt='EdwinChan' />
                <h5 class='desc'>
                    Head, Product and Market Management, Transaction Banking APAC
                </h5>
            </Grid>
        </>
    );
