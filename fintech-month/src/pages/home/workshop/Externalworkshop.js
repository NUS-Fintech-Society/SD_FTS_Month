                ...
                {texts.map((text) =>{   
                    ...
                    <Box className={classes.container1}>
                        ...
                        <Box data-aos="fade-left" className={classes.container3}>
                            <Externalworkshoptemplate description={text.description} content={text.content} author={text.author} speakerImage={text.speakerImage} className={classes.template}/>                
                        </Box>
                    </Box>
                    )
                    })}
